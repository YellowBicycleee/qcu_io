...
int main(int argc, char* argv[]) {
  ...
  CHECK_CUDA(cudaMemcpy(d_src_ptr, h_src_ptr, sizeof(complex<double>) * mrhs_colorspinor_len,
                        cudaMemcpyHostToDevice));
  CHECK_CUDA(cudaMemcpy(d_dst_ptr, h_dst_ptr, sizeof(complex<double>) * mrhs_colorspinor_len,
                        cudaMemcpyHostToDevice));
  CHECK_CUDA(cudaMemcpy(d_gauge_ptr, h_gauge_ptr, sizeof(complex<double>) * gauge_len,
                        cudaMemcpyHostToDevice));
