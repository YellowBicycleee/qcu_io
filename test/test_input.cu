...
int main(int argc, char *argv[]) {
    ...
    CHECK_CUDA(cudaMemcpy(h_src_ptr,   d_src_ptr,   sizeof(complex<double>) * mrhs_colorspinor_len, cudaMemcpyDeviceToHost));
    CHECK_CUDA(cudaMemcpy(h_dst_ptr,   d_dst_ptr,   sizeof(complex<double>) * mrhs_colorspinor_len, cudaMemcpyDeviceToHost));
    CHECK_CUDA(cudaMemcpy(h_gauge_ptr, d_gauge_ptr, sizeof(complex<double>) * gauge_len,            cudaMemcpyDeviceToHost));
